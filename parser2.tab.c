...
{
       0,     0,     3,     7,     9,    12,    17,    21,    24,    27,
      29,    31,    33,    35,    37,    41,    44,    48,    52,    55,
      58,    64,    70,    76
};
...
{
      18,     0,    -1,    19,    21,     5,    -1,     3,    -1,     3,
      20,    -1,    20,    14,    15,    12,    -1,    14,    15,    12,
      -1,     4,    22,    -1,    22,    23,    -1,    23,    -1,    24,
      -1,    25,    -1,    27,    -1,    28,    -1,     9,    15,    12,
      -1,    11,    26,    -1,    15,    13,    26,    -1,    10,    13,
      26,    -1,    15,    12,    -1,    10,    12,    -1,     6,    15,
       8,    15,    12,    -1,     6,    16,     8,    15,    12,    -1,
       7,    15,     8,    15,    12,    -1,     7,    16,     8,    15,
      12,    -1
};
...
{
       0,    49,    49,    60,    60,    63,    71,    81,    84,    84,
      87,    87,    87,    87,    90,    93,    96,    96,    96,    96,
      99,   100,   103,   104
};
#endif
...
{
  "$end", "error", "$undefined", "BEGINING", "BODY", "END", "MOVE", "ADD",
  "TO", "INPUT", "STRING", "PRINT", "FULLSTOP", "SEMICOLON", "VAR_DECLAR",
  "VAR_ID", "INTEGER", "$accept", "program", "begining_section",
  "var_declarations", "body_section", "statements", "statement",
  "input_statement", "print_statement", "print_expression",
  "move_statement", "add_statement", 0
};
#endif
...
{
       0,     3,     0,     0,     0,     4,     1,     0,     0,     0,
       0,     0,     0,     0,     0,     7,     9,    10,    11,    12,
      13,     2,     6,     0,     0,     0,     0,     0,     0,     0,
       0,    15,     8,     5,     0,     0,     0,     0,    14,    19,
       0,    18,     0,     0,     0,     0,     0,    17,    16,    20,
      21,    22,    23
};
...
{
      13,     3,    18,    15,     5,     7,   -37,    -6,    17,    11,
       9,    -7,    -5,    10,    -8,    -6,   -37,   -37,   -37,   -37,
     -37,   -37,   -37,    14,    19,    20,    21,    22,    23,     0,
       2,   -37,   -37,   -37,    16,    24,    25,    26,   -37,   -37,
      -8,   -37,    -8,    30,    31,    32,    33,   -37,   -37,   -37,
     -37,   -37,   -37
};
...
{
      11,    12,    29,    13,    47,    14,    48,    30,    24,    25,
      26,    27,    39,    40,    41,    42,     1,     4,     6,     7,
       9,    10,    21,    22,    23,    28,    33,    34,    35,    36,
      37,    43,     0,     0,     0,    38,     0,     0,     0,    44,
      45,    46,    49,    50,    51,    52,     0,     0,     0,    32
};

static const yytype_int8 yycheck[] =
{
       6,     7,    10,     9,    40,    11,    42,    15,    15,    16,
      15,    16,    12,    13,    12,    13,     3,    14,     0,     4,
      15,    14,     5,    12,    15,    15,    12,     8,     8,     8,
       8,    15,    -1,    -1,    -1,    12,    -1,    -1,    -1,    15,
      15,    15,    12,    12,    12,    12,    -1,    -1,    -1,    15
};
...
{
       0,     3,    18,    19,    14,    20,     0,     4,    21,    15,
      14,     6,     7,     9,    11,    22,    23,    24,    25,    27,
      28,     5,    12,    15,    15,    16,    15,    16,    15,    10,
      15,    26,    23,    12,     8,     8,     8,     8,    12,    12,
      13,    12,    13,    15,    15,    15,    15,    26,    26,    12,
      12,    12,    12
};
...
#line 63 "parser2.y"
    { 
                        if (isVarDeclared((yyvsp[(3) - (4)].name))) {
                            printf("Error: Variable %s is already declared. lineno - (%d)\n", (yyvsp[(3) - (4)].name), yylineno);
                            
                        } else {
                            addNewVar((yyvsp[(3) - (4)].name), (yyvsp[(2) - (4)].capacity)); 
                        }
                    ;}
    break;
...
#line 71 "parser2.y"
    { 
                        if (isVarDeclared((yyvsp[(2) - (3)].name))) {
                            printf("Error: Variable %s is already declared. lineno - (%d)\n", (yyvsp[(2) - (3)].name), yylineno);
                            
                        } else {
                            addNewVar((yyvsp[(2) - (3)].name), (yyvsp[(1) - (3)].capacity)); 
                        }
                    ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 99 "parser2.y"
    {checkMoveVarCapacity((yyvsp[(2) - (5)].name), (yyvsp[(4) - (5)].name));;}
    break;
...
/* Line 1455 of yacc.c  */
#line 100 "parser2.y"
    {checkMoveIntCapacity((yyvsp[(2) - (5)].integer_value), (yyvsp[(4) - (5)].name));;}
    break;
...
/* Line 1455 of yacc.c  */
#line 103 "parser2.y"
    {checkAddVarCapacity((yyvsp[(2) - (5)].name), (yyvsp[(4) - (5)].name));;}
    break;
...
/* Line 1455 of yacc.c  */
#line 104 "parser2.y"
    {checkAddIntCapacity((yyvsp[(2) - (5)].integer_value), (yyvsp[(4) - (5)].name));;}
    break;



/* Line 1455 of yacc.c  */
#line 1477 "parser2.tab.c"
      default: break;
    }
